"""
Django settings for cyclo_domestique project.
...
SECRET_KEY = 'django-insecure-1a4fr#2fzep9t2vwfkwm(tz==9bk)9@q$yllgc(y@#sfx(76bd'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['cyclo-domestique.herokuapp.com', 'localhost']
...
INSTALLED_APPS = [
    ...
    # The following apps are required alluth:
...
ROOT_URLCONF = 'cyclo_domestique.urls'
...
DEFAULT_FROM_EMAIL = 'cycledomestique@example.com'
